  ...
  return (
    <section className="inst-v2">
      ...
      <style>{`
        ...
        .inst-v2__title { font-family: 'Source Sans 3', sans-serif; font-size: clamp(2.5rem, 4.5vw, 4.6rem); line-height: 0.95; font-weight: 800; text-transform: uppercase; letter-spacing: 0; color: #003057; margin: 40px 0 0; max-width: 5ch; }
