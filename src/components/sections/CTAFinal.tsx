  ...
  return (
    <section className="cta-v2">
      ...
      <style>{`
        ...
        .cta-v2__quote-mark { font-size: 40px; color: #D9C756; line-height: 1; display: block; margin-bottom: 12px; }
        ...
        .cta-v2__call-btn { display: inline-block; background: #D9C756; color: #003057; padding: 14px 32px; border-radius: 60px; font-family: 'Source Sans 3', sans-serif; font-size: 13px; font-weight: 700; text-decoration: none; transition: all 0.3s; letter-spacing: 0.05em; }
        .cta-v2__call-btn:hover { background: #B8A63F; color: #003057; transform: translateY(-2px); }
