  ...
  return (
    <section className="tipos-v2">
      ...
      <style>{`
        ...
        .tipos-v2__tag { font-family: 'Source Sans 3', sans-serif; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: #8A7826; display: inline-flex; align-items: center; gap: 8px; margin-bottom: 16px; }
        .tipos-v2__title { font-family: 'Source Sans 3', sans-serif; font-size: clamp(20px, 2.8vw, 34px); font-weight: 800; color: #003057; margin: 0; line-height: 1.15; letter-spacing: -0.02em; }
        .tipos-v2__cta { background: #D9C756; color: #003057; border: none; padding: 14px 32px; border-radius: 60px; font-family: 'Source Sans 3', sans-serif; font-size: 12px; font-weight: 700; cursor: pointer; transition: all 0.3s ease; letter-spacing: 0.08em; text-transform: uppercase; align-self: flex-start; margin-top: 8px; }
        .tipos-v2__cta:hover { background: #B8A63F; color: #003057; transform: translateY(-2px); }
        ...
        .tipos-v2__card-num { width: 48px; height: 48px; border-radius: 50%; background: #C8A84A; color: white; display: flex; align-items: center; justify-content: center; font-family: 'Source Sans 3', sans-serif; font-size: 18px; font-weight: 700; margin-bottom: 24px; }
        ...
        .tipos-v2__card-title { font-family: 'Source Sans 3', sans-serif; font-size: 20px; font-weight: 700; color: #003057; margin: 0 0 16px; }
        .tipos-v2__card-desc { font-family: 'Source Sans 3', sans-serif; font-size: 14px; color: #666; line-height: 1.6; margin: 0 0 20px; }
        .tipos-v2__card-list { list-style: none; padding: 0; margin: 0; }
        .tipos-v2__card-list:not(:empty) { margin-bottom: 20px; }
        .tipos-v2__card-list li { font-family: 'Source Sans 3', sans-serif; font-size: 14px; color: #555; line-height: 1.5; padding: 6px 0 6px 20px; position: relative; }
