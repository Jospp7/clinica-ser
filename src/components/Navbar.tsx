    ...
    <nav aria-label="Navegación principal" className="nav-ser">
      ...
      <style>{`
        .nav-ser { position: fixed; top: 0; left: 0; right: 0; z-index: 100; }
         .nav-ser__bar { display: flex; align-items: center; justify-content: space-between; height: 96px; padding: 0 clamp(16px,3vw,48px); background: #FFFFFF; backdrop-filter: blur(24px) saturate(1.4); -webkit-backdrop-filter: blur(24px) saturate(1.4); border-bottom: 1px solid rgba(0, 0, 0, 0.08); box-shadow: 0 4px 24px rgba(0, 0, 0, 0.08); transition: all .3s ease; }
         .nav-ser__bar--scrolled { background: rgba(255, 255, 255, 0.99); box-shadow: 0 4px 24px rgba(0, 0, 0, 0.16); }
         .nav-ser__logo { position: relative; z-index: 1; display: flex; align-items: center; justify-content: center; text-decoration: none; flex-shrink: 0; align-self: center; height: 150px; margin-left: 0; background: transparent; border: none; border-radius: 0; padding: 0; box-shadow: none; transition: background .3s ease; }

         .nav-ser__logo:hover { background: transparent; }
         .nav-ser__logo-img { position: relative; z-index: 1; height: 150px; width: auto; display: block; }
         ...
         .nav-ser__dropdown-cta:hover { background: #B8A63F; color: var(--brand-navy); }
          ...
          @media (max-width: 900px) {
            ...
            .nav-ser__logo-img { height: 110px; }
            .nav-ser__logo { height: 120px; padding: 0; border-radius: 0; }
          }
