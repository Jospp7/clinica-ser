  ...
  return (
    <main>
      ...
      <style>{`
        ...
        .guia__hero { position: relative; min-height: 50vh; display: flex; align-items: center; background: linear-gradient(135deg, #003057 0%, #003057 100%); }
        ...
        .guia__cta h2 { font-size: 24px; font-weight: 700; color: #003057; margin: 0 0 12px; }
