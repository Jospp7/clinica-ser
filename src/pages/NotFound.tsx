  ...
  return (
    <main className="nf">
      ...
      <style>{`
        ...
        .nf__code { font-family: 'Source Sans 3', sans-serif; font-size: 14px; font-weight: 600; letter-spacing: .2em; color: #8A7826; text-transform: uppercase; display: block; margin-bottom: 16px; }
        .nf__title { font-family: 'Source Sans 3', sans-serif; font-size: clamp(28px,4vw,44px); font-weight: 700; color: #003057; line-height: 1.2; margin: 0 0 20px; }
        .nf__lead { font-family: 'Source Sans 3', sans-serif; font-size: 16px; color: #555; line-height: 1.7; margin: 0 auto 32px; max-width: 620px; }
        .nf__ctas { display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; margin-bottom: 24px; }
        .nf__cta { display: inline-flex; align-items: center; gap: 8px; padding: 14px 28px; border-radius: 60px; font-family: 'Source Sans 3', sans-serif; font-size: 14px; font-weight: 600; text-decoration: none; transition: all .2s; }
        .nf__cta--primary { background: #D9C756; color: #003057; }
        .nf__cta--primary:hover { background: #B8A63F; color: #003057; }
        .nf__cta--wa { background: #25D366; color: white; }
        .nf__cta--wa:hover { background: #1DA851; }
        .nf__back { margin-top: 8px; }
        .nf__back-link { display: inline-flex; align-items: center; gap: 6px; font-family: 'Source Sans 3', sans-serif; font-size: 14px; color: #555; text-decoration: none; }
        .nf__back-link:hover { color: #003057; }

        .nf__sections { padding: 0 0 clamp(80px,10vw,120px); }
        .nf__sections-title { font-family: 'Source Sans 3', sans-serif; font-size: clamp(20px,2.5vw,26px); font-weight: 700; color: #003057; text-align: center; margin: 0 0 32px; }
        .nf__grid { list-style: none; padding: 0; margin: 0; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; }
        .nf__card { display: flex; align-items: center; gap: 12px; background: white; border: 1px solid rgba(0,0,0,0.06); border-radius: 16px; padding: 18px 20px; font-family: 'Source Sans 3', sans-serif; font-size: 15px; font-weight: 600; color: #003057; text-decoration: none; transition: all .2s; }
        .nf__card:hover { border-color: #D9C756; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.06); }
      `}</style>
    </main>
  );
};
