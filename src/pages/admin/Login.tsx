...
const Login = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#003057", fontFamily: "'Source Sans 3', sans-serif" }}>
      <form onSubmit={handleSubmit} style={{ background: "white", borderRadius: 16, padding: "48px 40px", width: "100%", maxWidth: 400, boxShadow: "0 20px 60px rgba(0,0,0,.3)" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 20, fontWeight: 700, color: "#003057", margin: 0 }}>Panel de Administración</h1>
        </div>
